"""
Auto-generated from 02_silver_stream_green.ipynb
"""
import sys
...
from src.transformations.tlc_rules import (
    GREEN_RULES, apply_quality_flags, route_quarantine
)
...
KAFKA_TOPIC     = os.getenv("KAFKA_TOPIC_GREEN_2026",  "tlc-green-2026")
VEHICLE_TYPE    = "green"
...
spark = get_spark_streaming(
    app_name="TLC_Silver_Stream_GREEN_2026",
...
GREEN_RECORD_SCHEMA = T.StructType([
...
def process_batch(batch_df: DataFrame, batch_id: int) -> None:
    ...
    flagged_df = apply_quality_flags(parsed_df, GREEN_RULES)
    ...
    if records_valid > 0:
        ...
        silver_df = build_green_silver(enriched_df, run_id=stream_run_id)
        ...
        print(f"  ✓ Silver written: {n_silver:,} rows → tlc_silver.trips_green")
    ...
    if records_rejected > 0:
        ...
        quarantine_df_mapped = rejected_df.select(
            ...
            F.lit("silver_stream_green").alias("pipeline"),
    ...
    audit_record = {
        ...
        "pipeline_name":  "silver_stream_green",
        "status":         "SUCCESS",
